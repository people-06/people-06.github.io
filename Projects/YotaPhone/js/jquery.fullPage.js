		...
		*/
		function removeMouseWheelHandler(){
			if (document.addEventListener) {
                ...
                document.removeEventListener('MozMousePixelScroll', MouseWheelHandler, false); //Firefox
			} else {
		...
		*/
		function addMouseWheelHandler(){
			if (document.addEventListener) {
                ...
                document.addEventListener("MozMousePixelScroll", MouseWheelHandler, false); //Firefox
			} else {
